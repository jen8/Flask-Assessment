...
# when user post a form to a route, the receiving route needs to expect a "post"
...
def confirm_application_submission():
    """Show Confirmation That Application Was Received"""
...
# runs the server at IP address 0.0.0.0
    app.run(host="0.0.0.0")

### HAVING ISSUES WITH DEBUG TOOLBAR
